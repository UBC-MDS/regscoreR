...
test_that("bic() returns the BIC score of a specific model, given observed y, predicted y and number of variables used for prediction", {
  ...
  expect_error(bic(c(1,2,3,4), c(5,6,7,8,9), 3), "Error: Input vectors must be of equal lengths")
  expect_error(bic(c(1,2,3,4,5,6,7), c(5,6,7,8,9), 2), "Error: Input vectors must be of equal lengths")
  ...
  expect_error(bic(c(2), c(5,6,7,8), 3), "Error: Length of argument 1 cannot be less than or equal to 1")
  expect_error(bic(c(1,2,3,4), c(3), 3), "Error: Length of argument 2 cannot be less than or equal to 1")
  ...
  expect_error(bic(as.data.frame(c(1,2,3,4)), c(5,6,7,8), 3), "Error: Argument 1 is not a vector")
  expect_error(bic(2, c(5,6,7,8), 3), "Error: Length of argument 1 cannot be less than or equal to 1")
  ...
  expect_error(bic(c(1,2,3), 2, 3), "Error: Length of argument 2 cannot be less than or equal to 1")
  ...
  expect_error(bic(c(1,2,3), c(5,6,7), 1.75), "Error: Number of variables must be a positive integer")
  ...
  # expected outputs
  expect_equal(round(bic(c(1,2,3,4), c(5,6,7,8), 3), 3), 15.249)
  expect_equal(round(bic(c(-5,1,-8,-12), c(-4,-6,-8,1), 5), 3), 22.943)
})
